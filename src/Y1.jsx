            ...
            navigator.geolocation.getCurrentPosition(
                (position) => {
                    ...
                    if (mapInstancRef.current) {
                        mapInstancRef.current.setCenter([latitude, longitude]);
                        mapInstancRef.current.setZoom(13);
                        ...
                        const placemark = new window.ymaps.Placemark(
                            ...
                            },
                            {
                                ...
                                iconColor: 'rgb(255, 130, 14)'
                            }
                        );
                        mapInstancRef.current.geoObjects.add(placemark);
                    }
                },
                (error) => {
                    ...
                    if (mapInstancRef.current) {
                        mapInstancRef.current.setCenter([51.6607, 39.2003]);
                        mapInstancRef.current.setZoom(13);
